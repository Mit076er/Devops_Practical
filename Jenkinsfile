        ...
        stage('build') {
            ...
            steps {
                script{
                    ...
                    sh "docker build -t m076er/nginx:${IMAGE_NAME} ."    
                    }
            }
        }
      stage('test') {
        ...
        // }
            steps {
                ...
                withCredentials([usernamePassword(credentialsId: 'docker', usernameVariable: 'USERNAME', passwordVariable: 'PASSWORD')]){
                    ...
                    sh "docker push m076er/nginx:${IMAGE_NAME}"
                }}
        ...
        stage('deploy'){
            steps{
                script{
                    ...
                    def dockerRunCmd = "sudo docker run -p 8080:8080 -d m076er/nginx:${IMAGE_NAME}"
                  sshagent(['ec2-prod']) {
                        sh "ssh -o StrictHostKeyChecking=no ec2-user@54.163.52.121 ${dockerRunCmd}"
                    }  
                }
            }
        }
