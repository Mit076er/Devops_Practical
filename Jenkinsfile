        ...
        stage('build') {
            ...
            steps {
                script{
                    ...
                    sh "docker build -t Mit076er/Devops_Practical:${IMAGE_NAME} ."
        ...
        input{
            ...
            steps {
                ...
                withCredentials([usernamePassword(credentialsId: 'docker', usernameVariable: 'USERNAME', passwordVariable: 'PASSWORD')]){
                    ...
                    sh "docker push Mit076er/Devops_Practical:${IMAGE_NAME}"
                }}
            ...
            steps{
                script{
                    withCredentials([usernamePassword(credentialsId: 'git-credentials', usernameVariable: 'USERNAME', passwordVariable: 'PASSWORD')]){
                        ...
                        sh "git remote set-url origin https://${USERNAME}:${PASSWORD}@github.com/https://github.com/Mit076er/Devops_Practical.git"
                        sh 'git add .'
